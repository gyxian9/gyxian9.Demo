...
import com.gyxian9.hx_wechat.common.NetUtil;
...
public class NetClient {
	...
	// Imageload缓存目录
	private static File cacheDir = new File(App.get_CacheDir() + "/Imageload");
	...
	public void get(String url, RequestParams params,
		...
		if (!NetUtil.checkNetWork(context)) {
			Utils.showLongToast(context, Constant.NET_ERROR);
			return;
		}
		try {
			if (params != null)
