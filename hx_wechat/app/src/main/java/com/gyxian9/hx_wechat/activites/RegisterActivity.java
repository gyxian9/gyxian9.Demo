...
public class RegisterActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void getRegister() {
        ...
        netClient.post(Constant.RegistURL, params, new BaseJsonRes() {

            @Override
            public void onMySuccess(String data) {
                Utils.putValue(RegisterActivity.this, Constant.USERINFO, data);
                Utils.putValue(RegisterActivity.this, Constant.NAME, name);
                Utils.putValue(RegisterActivity.this, Constant.PASSWD,
                        DES.md5Pwd(pwd));
    ...
    private void getCode() {
        ...
        netClient.post(Constant.SendCodeURL, params,
